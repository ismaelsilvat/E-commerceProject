fetch("../products.json")
    .then(response => response.json()).then(products => {
        ...
        const containerSpecial= document.getElementById('container-specials');
        ...
        for (let index = 0; index < products.length; index++) {
            ...
            if (product.tipo == 'especial') {
                ...
                containerSpecial.innerHTML = containerSpecial.innerHTML + modeloDeProduto2;
            }
        }   
        for(let index = 0; index < products.length; index++){

            if (products[index].tipo == 'especial') {
        ...
        let indexteste = 0
            for(let indexxx = 0; indexxx < products.length; indexxx++){
                ...
                if (products[indexxx].tipo == 'especial') {
