fetch("../products.json")
    .then(response => response.json()).then(products => {
        ...
        const containerKids = document.getElementById('container-kids');
        ...
        for (let index = 0; index < products.length; index++) {
            ...
            if (product.tipo == 'infantilMasc' || product.tipo == 'infantilFem') {
                ...
                containerKids.innerHTML = containerKids.innerHTML + modeloDeProduto2;
            }
        }   
        for(let index = 0; index < products.length; index++){

            if (products[index].tipo == 'infantilMasc' || products[index].tipo == 'infantilFem' ) {
        ...
        let indexteste = 0
            for(let indexxx = 0; indexxx < products.length; indexxx++){
                ...
                if (products[indexxx].tipo == 'infantilMasc' || products[indexxx].tipo == 'infantilFem') {
