fetch("../test.json")
    .then(response => response.json()).then(produtos => {
        ...
        for (let index = 0; index < produtos.length; index++) {
            ...
            if (produto.tipo == 'infantilMasc' || produto.tipo == 'infantilFem') {
            ...
            for(let index = 0; index < produtos.length; index++){
                ...
                if (produtos[index].tipo == 'infantilMasc' || produtos[index].tipo == 'infantilFem') {
                    ...
                    let indexteste = 0
                        for(let indexxx = 0; indexxx < produtos.length; indexxx++){
                            ...
                            if (produtos[indexxx].tipo == 'infantilMasc' || produtos[indexxx].tipo == 'infantilFem') {
