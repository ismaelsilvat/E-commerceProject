fetch("../products.json")
    .then(response => response.json()).then(products => {
        ...
        const containerGuys = document.getElementById('container-guys');
        ...
        for (let index = 0; index < products.length; index++) {
            ...
            if (product.tipo == 'infantilMasc') {
                ...
                containerGuys.innerHTML = containerGuys.innerHTML + modeloDeProduto2;
            }
        }   
        for(let index = 0; index < products.length; index++){

            if (products[index].tipo == 'infantilMasc') {
        ...
        let indexteste = 0
            for(let indexxx = 0; indexxx < products.length; indexxx++){
                ...
                if (products[indexxx].tipo == 'infantilMasc') {
