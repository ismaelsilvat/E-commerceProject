fetch("../products.json")
    .then(response => response.json()).then(products => {
        ...
        const containerGirls = document.getElementById('container-girls');
        ...
        for (let index = 0; index < products.length; index++) {
            ...
            if (product.tipo == 'infantilFem') {
                ...
                containerGirls.innerHTML = containerGirls.innerHTML + modeloDeProduto2;
            }
        }   
        for(let index = 0; index < products.length; index++){

            if (products[index].tipo == 'infantilFem') {
        ...
        let indexteste = 0
            for(let indexxx = 0; indexxx < products.length; indexxx++){
                ...
                if (products[indexxx].tipo == 'infantilFem') {
