fetch("../products.json")
    .then(response => response.json()).then(products => {
        ...
        const containerMen = document.getElementById('container-men');
        ...
        for (let index = 0; index < products.length; index++) {
            ...
            if (product.tipo == 'masculino') {
                ...
                containerMen.innerHTML = containerMen.innerHTML + modeloDeProduto2;
            }
        }   
        for(let index = 0; index < products.length; index++){

            if (products[index].tipo == 'masculino') {
        ...
        let indexteste = 0
            for(let indexxx = 0; indexxx < products.length; indexxx++){
                ...
                if (products[indexxx].tipo == 'masculino') {
